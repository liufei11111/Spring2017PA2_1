...
public class Config {
  ...
  // tuned
  public static double languageModelScalingFactor = 0.37;// empirical value for language model scaling
  public static double smoothingFactor=0.4;// tested not significant 146 ..
