  ...
  public static NoisyChannelModel load() throws Exception {
    try {
      ...
      if (ncm_ == null) {
        ...
        ncm_.empiricalCostModel.del = me.retrieveMapStringInteger(Config.delFile);
        ncm_.empiricalCostModel.ins = me.retrieveMapStringInteger(Config.insFile);
        ncm_.empiricalCostModel.del = me.retrieveMapStringInteger(Config.subFile);
        ncm_.empiricalCostModel.trans = me.retrieveMapStringInteger(Config.transFile);
        ncm_.empiricalCostModel.occurence = me.retrieveMapStringInteger(Config.occurenceFile);
        ncm_.empiricalCostModel.occurence2 = me.retrieveMapStringInteger(Config.occurence2File);
        oisA.close();
      }
    } catch (Exception e) {
